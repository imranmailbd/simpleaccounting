...
class Index{
    ...
    <section class="service-area-new-c"> 
        ...
        <section>
                ...
                <div class="our-strength" style="margin-top: 80px;">';
                    ...
                    if($serviceObj){                        
                        ...
                        while($oneRow = $serviceObj->fetch(PDO::FETCH_OBJ)){
                            ...
                            // if($oneRow->uri_value !='#'){
                            //     $services_uri = str_replace('//', '/', '/businessformation-services/'.trim(stripslashes($oneRow->uri_value))).'.html';
                            // }
                            // else{
            ...
            <!--a href="businessformation-services.html" class="btn-more-bg animatedBtnBody">See All Our Services</a-->
            <a href="businessformation-services.html" class="btn_r orange">See All Business Formation Services</a>
            </p> 
    </section>       
     ...
     <!-- Our Specialist part starts here -->  
        ...
        <section class="our-expert-team">
            ...
            <div class="container">
                ...
                <!--a href="businessformation-services.html" class="btn-more-bg animatedBtnBody">See All Our Stuff</a-->
                                    ...
                                    while($oneRow = $FMObj->fetch(PDO::FETCH_OBJ)){
                                        ...
                                        if($FMObj2){                  
                                            ...
                                            while($oneRow2 = $FMObj2->fetch(PDO::FETCH_OBJ)){
                                                ...
                                                $manuStr .= "<li><a href=\"/businessformation-services$subMenuUri\" style=\"font-style: normal; font-weight: 300; font-display: swap;\" ><i style=\"float:left; padding: 4px 5px;\" class=\"fa fa-caret-right\"></i>$subName</a></li>";
