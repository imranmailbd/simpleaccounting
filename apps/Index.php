...
class Index{
	...
	public function home(){  
        ...
        <section>
            ...
            if($bannObj){
                ...
                while($oneRow = $bannObj->fetch(PDO::FETCH_OBJ)){
                    ...
                    $returnHTML .= '       
                    <div class="carousel-cell" style="background-image:url(\''.$catImgSrc.'\');">
                        <div class="slide-content">
                            <div class="mask">
                                <p class="caption"> '.$name.'</p>
                            </div>
                            <div class="mask">
                                <a href="'.baseURL.'/contact-us.html" class="btn">'.$description.'</a>
                            </div>
                        </div>
                    </div>';
        ...
        <!-- About Us Area Start -->
        <section class="abouts-area" style="padding-top: 100px;">                    
            <div class="container">                        
                <div class="row">
        ...
        <section class="service-area-new-c"> 
            ...
            <section>
                    ...
                    <div class="our-strength" style="margin-top: 80px;">';
                        ...
                        if($serviceObj){                        
                            ...
                            while($oneRow = $serviceObj->fetch(PDO::FETCH_OBJ)){
                                ...
                                // if($oneRow->uri_value !='#'){
                                //     $services_uri = str_replace('//', '/', '/bour-services/'.trim(stripslashes($oneRow->uri_value))).'.html';
                                // }
                                // else{
                ...
                <!--<a href="our-services.html" class="btn_r orange">See All Business Formation Services</a>-->
                </p> 
        </section>       
     ...
     <!-- Our Specialist part starts here -->  
              <section class="container expertise-card-design" style="margin-bottom: 88px;"> 
                <div class="simple-card" style="margin-top: 56px;">
                        ...
                        <div class="our-strength-feat" style="margin-top: 60px;">
                            <div class="strength-card-feat">
                                <div class="strength-card-content-feat"> 
                                    <div class="d-flex">
        ...
        <section class="our-expert-team">
            ...
            <div class="container">
                ...
                <div class="row">';
                    ...
                    $customerObj = $this->db->getObj("SELECT teams_id, name, uri_value, address FROM teams WHERE teams_publish = 1 ORDER BY RAND() LIMIT 0,4", array());
                ...
                <!--a href="our-services.html" class="btn-more-bg animatedBtnBody">See All Our Stuff</a-->
                                                                ...
                                                                <div class="pageTransBody">
                                                                    <div class="row mt-5" style="margin:0 auto;margin-top:0px !important;">
                                                                        ...
                                                                        <div class="u-section-1">';
                                                                            ...
                                                                            $prodObj = $this->db->getObj("SELECT accounting_services_id AS id, name, description, price FROM accounting_services WHERE accounting_services_publish = 1 AND accounting_services_id=$service_id", array());
                                                                            if($prodObj){
                                                                                while($oneRow = $prodObj->fetch(PDO::FETCH_OBJ)){
                                                                                    // $returnHTML .= $this->productShortHTML($oneRow); 
                                                                                    // var_dump($oneRow);
                                                                            ...
                                                                            <div class="col-md-12 sec-title" style="border:0px solid red; margin-left:0px; margin-top:5px !important;margin-bottom:0px !important;">
                                                                
                                                                            <h5>Order now: <span class="text-justify" style="font-weight:900 !important;"> '.$service_name.' </span>service </h5>
                                                                                <hr>
                                                                                <p> 
                                                                                '.$service_description.'
                                                                                </p>
                                                                            ...
                                                                            <div id="contact" class="col-md-12" style="border:0px solid red; ">
                                                                                    ...
                                                                                    <form id="user_form" novalidate action="form_action.php"  method="post">	
                                                                                        ...
                                                                                        <fieldset>                
                                                                                            ...
                                                                                            <div class="row my-3 bg-success pt-5 pl-3 " style="border-radius:5px; font-size:16px; color:#fff;">
                                                                                                    <div style="padding-left: 0px !important;" class=" col-lg-4 col-sm-12">
                                                                                                        <label class="setp-field-lbl">Choose The Service To Buy <span class="required">*</span></label>
                                                                                                    </div>
                                                                                                    
                                                                                                    <label class="col-lg-8 col-sm-12 rd_container">
                                                                                                            <input name="jurisdiction" type="radio" value="12.80" checked="checked" id="" tabindex="1">
                                                                                                            <span class="ms-3 txt-white">'.$service_name.'  at price '.$regularPriceStr.'</span> 
                                                                                                    </label>
                                                                                            ...
                                                                                            <!--<input type="button" class="next btn-color mt-3" value="Order Now" />-->
                                                                                            ...
                                                                                            <!--<input type="button" name="previous" class="previous btn-color" value="Go First Step" />-->
                                                                                            ...
                                                                                            <input type="button" onclick="addToCart('.$services_id.', \''.addslashes($service_name).'\', '.$service_price.',\''.$prodPictures[0][1].'\');" tabindex="0" class="submit btn-color" value="Order Now" />
                                                                                        ...
                                                                                        <fieldset>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td colspan="2" style="font-size:14px; font-weight:bold; background-color:#EEE; border-bottom:1px solid #DFDFDF; padding:7px 7px">You are ordering below service to buy</td>
                                                                                                </tr>
                                                                                                <tr bgcolor="#ffffff">
                                                                                                    ...
                                                                                                    <td colspan="2">
                                                                                                        ...
                                                                                                        <tbody><tr>
                                                                                                                                <td style="border-bottom:1px solid #DFDFDF; border-right:1px solid #DFDFDF; padding:7px; font-family: sans-serif; font-size:11px;">
                                                                                                                                    <strong style="color:#BF461E; font-size:12px; margin-bottom:5px">'.$service_name.'</strong>
                                                                                                                                ...
                                                                                                                                <td style="border-bottom:1px solid #DFDFDF; border-right:1px solid #DFDFDF; padding:7px; width:155px; font-family: sans-serif; font-size:11px;">$ '.$service_price.' CAD</td>
                                                                                                                                <td style="border-bottom:1px solid #DFDFDF; border-right:1px solid #DFDFDF; padding:7px; width:155px; font-family: sans-serif; font-size:11px;">$ '.$service_price.' CAD</td>
                                                                                                                            </tr></tbody>
                                                                                                        <tfoot>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="border-bottom:1px solid #DFDFDF; border-right:1px solid #DFDFDF; padding:7px; width:155px; font-family: sans-serif;"><strong style="font-size:12px;">$ '.$service_price.' CAD</strong></td>
                                                                                                            </tr>
                                                                                                        </tfoot>
                                                                                                        </table>
                                                                                                    </td>
                                                                                            ...
                                                                                            <!--input type="submit" name="submit" class="submit btn btn-danger" value="Proceed To Pay" /-->
                                                                                            <!--<input type="button" onclick="addToCart(1, \'Nuans Report\', 12.80,\'./assets/accounts/serv_1_805.png\');" tabindex="0" class="submit btn-color" value="Proceed To Pay" />-->
                                                                                            <input type="button" onclick="addToCart('.$services_id.', \''.addslashes($service_name).'\', '.$service_price.',\''.$prodPictures[0][1].'\');" tabindex="0" class="submit btn-color" value="Proceed To Pay" />
                                        ...
                                        <div class=\"row\">";                                            
                                            ...
                                            $returnHTML .='<section id="what-we-do">
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    $tableObj = $this->db->getObj("SELECT services_id, name, font_awesome, uri_value, short_description FROM services WHERE services_publish =1 AND service_type =1 ORDER BY services_id", array());

                                                    $totalRows = $tableObj->rowCount();
                                                    ...
                                                    if($tableObj){ 
                                                        ...
                                                        while($oneRow = $tableObj->fetch(PDO::FETCH_OBJ)){
                                                            ...
                                                            $returnHTML .='
                                                            <div class="strength-card-system-innerpage">
                                                                <div class="strength-card-contents mb-2"> 
                                                                        '.$pageImg.' 
                                                                            <h3>'.$name.'</h3>
                                                                            <span>'.$short_description.'</span>
        ...
        if(!empty($segment3URI)){
            ...
            if($id>0){     
                ...
                $returnHTML = "<meta http-equiv = \"refresh\" content = \"0; url = '/$uri_value.html'\" />";
                    ...
                    $bodyPages = array(1=>array(), 2=>array(), 3=>array(), 4=>array(), 5=>array(), 6=>array(), 7=>array(), 8=>array(), 9=>array(), 10=>array(), 63=>array());
                                            ...
                                            $returnHTML .='<section id="what-we-do">
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="section-title text-center">                                            
                                                        ...
                                                        <h2 class="page-title">'.$bodyPages[63][0].'</h2>

                                                    </div>

                                                    <!--p class="text-center text-muted h5">'.$bodyPages[63][1].'</p-->
    ...
    private function sidebarHTML(){              
                                ...
                                if($FMObj){
                                    ...
                                    while($oneRow = $FMObj->fetch(PDO::FETCH_OBJ)){
                                        ...
                                        if($FMObj2){                  
                                            ...
                                            $manuStr .= "<a href=\"/our-services.html\" class=\"\">$rootName</a>";
    
                                            $mobileManuStr .= "<a href=\"our-services.html\">$rootName</a>";                
                                            ...
                                            while($oneRow2 = $FMObj2->fetch(PDO::FETCH_OBJ)){
                                                ...
                                                $manuStr .= "<li><a href=\"/our-services$subMenuUri\" style=\"font-style: normal; font-weight: 300; font-display: swap;\" ><i style=\"float:left; padding: 4px 5px;\" class=\"fa fa-caret-right\"></i>$subName</a></li>";
        ...
        } else if($segment2URI == "our-services"){
                                    ...
                                    while($oneRow = $FMObj->fetch(PDO::FETCH_OBJ)){
                                        ...
                                        if($FMObj2){                  
                                            ...
                                            while($oneRow2 = $FMObj2->fetch(PDO::FETCH_OBJ)){
                                                ...
                                                $manuStr .= "<li><a href=\"/our-services$subMenuUri\" style=\"font-style: normal; font-weight: 300; font-display: swap;\" ><i style=\"float:left; padding: 4px 5px !important;\" class=\"fa fa-caret-right\"></i>$subName</a></li>";
