...
define('COMPANYNAME', 'Simple Accounting & Tax Solutions Inc.');
define('LIVE_DOMAIN', 'simpleaccounting.ca');

$approvedDomains = array(LIVE_DOMAIN, 'sksoftsolutions.ca','sksoftsolutionsl.ca');
...
if(in_array($subdomain, array('', 'www','simpleaccounting'))){
	$title = 'Simple Accounting & Tax Solutions Inc.';
	...
	if(in_array($segment2URI, array('appointments', 'accounting-services', 'Checkout', 'other-services', 'about-us', 'set_sessionBranchesId', 'checkRegistered', 'My_Order', 'getPOSInfo', 'home', 'forbidden', 'our-team', 'immigration', 'fingerprint', 'legal-services', 'fingerprint-services', 'nuans-service', 'soleproprietorship-service', 'federal-service', 'ontario-service', 'business-service', 'professional-service', 'company-assessment', 'our-services', 'practice-areas', 'videos-main', 'gallery-main', 'search', 'sendAssessments', 'checkMVCVerified', 'checkShippingAddress', 'confirmCheckOut', 'contact-us', 'why-choose-us', 'news-articles', 'sendContactUs','fetchNews'))){
		...
		$functionName = str_replace('our-services', 'ourServices', $functionName);
		...
		elseif($functionName=='accountingservices'){
			$title = trim(stripslashes('Our Services'));
		}
		...
		elseif($functionName=='ourServices'){
			$title = trim(stripslashes('Our Services'));
		}
